...
/* ============================================================
   ANNOUNCEMENT FORM - DEEPSEEK-STYLE RESPONSIVE STYLES
...
<div class="announcement-form-container">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        <h3 class="fw-bold mb-0" style="font-size: 2rem; color: #1e2a3e;">
            <i class="fas fa-plus-circle me-2" style="color: #28a745;"></i>Create Announcement
        </h3>
    ...
    <form action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="file" name="image" id="image" class="form-control @error('image') is-invalid @enderror"
                   accept="image/*">
            <small class="text-muted d-block mt-1">Allowed: jpeg, png, jpg, gif, webp. Max 2MB.</small>
            @error('image')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-6">
                <div class="form-check form-switch form-check-switch-lg">
                    ...
                    <label for="is_published" class="form-check-label fw-semibold">Publish immediately</label>
                </div>
            </div>
            <div class="col-md-6">
                <label for="published_at" class="form-label fw-semibold">Schedule Publish Date (optional)</label>
